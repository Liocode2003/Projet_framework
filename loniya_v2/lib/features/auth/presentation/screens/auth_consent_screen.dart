        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Text(
                      'Protection des données — CIL Burkina Faso',
              ...
              Text(
                'Conformément à la loi n°010-2004/AN sur la protection des données personnelles du Burkina Faso.',
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 8),
                    _dataPoint('Numéro de téléphone (identification)'),
                    _dataPoint('Progression d\'apprentissage'),
                    _dataPoint('Scores et résultats'),
                    _dataPoint('Préférences de langue'),
                    const SizedBox(height: 12),
                    Text('Stockage : Local sur votre appareil. Aucune donnée n\'est transmise sans votre accord.',
              ...
              _ConsentCheckbox(
                ...
                label: 'J\'accepte la collecte et l\'utilisation de mes données à des fins éducatives.',
              ),
              const SizedBox(height: 12),
              _ConsentCheckbox(
                value: _termsConsent,
                onChanged: (v) => setState(() => _termsConsent = v ?? false),
                label: 'J\'ai lu et j\'accepte les conditions d\'utilisation de LONIYA V2.',
              ),
              const SizedBox(height: 12),
              _ConsentCheckbox(
                value: _minorConsent,
                onChanged: (v) => setState(() => _minorConsent = v ?? false),
                label: 'Si l\'utilisateur est mineur, le tuteur légal a donné son accord. (Optionnel)',
              ),
